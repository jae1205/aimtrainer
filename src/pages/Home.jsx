...
const COPY = {
  kr: {
    ...
    trainingSelect: '훈련 선택', skeet: '스키트', gridshot: '그리드', tracking: '랜덤 트래킹', switching: '동적 스위칭',
  ...
  en: {
    ...
    trainingSelect: 'SELECT TRAINING', skeet: 'SKEET', gridshot: 'GRID', tracking: 'RANDOM TRACKING', switching: 'DYNAMIC SWITCHING',
